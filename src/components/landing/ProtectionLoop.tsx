...
export function ProtectionLoop() {
  return (
    <section
      ...
      className="scroll-mt-20 border-y border-[#42433D] px-4 py-12 sm:px-6 lg:px-8"
    >
      <div className="mx-auto max-w-7xl">
        ...
        <ol className="grid border-l border-t border-[#42433D] sm:grid-cols-2 lg:grid-cols-5">
          {steps.map(([number, title, body]) => (
            <li key={number} data-motion-reveal="card" className="min-h-56 border-b border-r border-[#42433D] p-5">
