  ...
  return (
    <LandingMotion>
      <section
        ...
        className="relative isolate w-full min-w-0 max-w-full overflow-hidden border-b border-[#42433D] px-4 pb-12 pt-28 sm:px-6 sm:pb-16 sm:pt-32 lg:px-8 lg:pb-12"
      >
        <div aria-hidden="true" className="absolute inset-0 -z-20 bg-[#0E100F]" />
        <Image
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 -z-10 bg-[linear-gradient(rgba(14,16,15,0.88),rgba(14,16,15,0.6)),linear-gradient(rgba(255,252,225,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,252,225,0.02)_1px,transparent_1px)] bg-[size:auto,48px_48px,48px_48px] [mask-image:linear-gradient(to_bottom,black,transparent_90%)]"
        />
        <div className="relative z-10 mx-auto grid min-w-0 max-w-7xl items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.82fr)]">
          <div className="min-w-0 max-w-3xl">
            <p
              data-hero-reveal
              data-motion-reveal="line"
              className="mb-6 flex items-center gap-3 text-xs text-[#BBBAA6]"
            >
            ...
            <p
              ...
              className="mt-8 max-w-full break-words text-base leading-7 text-[#BBBAA6] sm:max-w-xl sm:text-lg sm:leading-8"
            >
            ...
            <div
              data-hero-reveal
              data-motion-reveal="line"
              className="mt-10 grid min-w-0 max-w-xl grid-cols-1 border-y border-[#42433D] py-2 sm:grid-cols-3 sm:py-4"
            >
          ...
          <div data-hero-reveal data-motion-reveal="lift">
            <RiskOrbit />
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center gap-4 overflow-x-auto px-4 text-xs [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:px-6 lg:px-8">
          <span
            data-motion-reveal="card"
            className="shrink-0 rounded-full border border-[#ABFF84]/40 px-3 py-1 text-[#ABFF84]"
          >
            LIVE
          </span>
          <div
            data-motion-reveal="line"
            className="flex min-w-max items-center gap-6 text-[#BBBAA6]"
          >
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-8 rounded-lg border border-[#42433D] bg-[#ABFF84]/[0.035] p-6 shadow-[0_16px_48px_rgba(0,0,0,0.25)] sm:p-8 lg:grid-cols-[1fr_auto] lg:items-end lg:p-12">
          <div>
            <p data-motion-reveal="line" className="mb-4 text-xs text-[#ABFF84]">
              LIVE ON CASPER TESTNET
            </p>
            <h2
              data-motion-reveal="title"
              className="max-w-3xl text-[clamp(2rem,5vw,4rem)] font-normal leading-[0.98]"
            >
              Stop depositing blind. Cover the vault.
            </h2>
            <p
              data-motion-reveal="lift"
              className="mt-5 max-w-2xl text-sm leading-7 text-[#BBBAA6] sm:text-base"
            >
